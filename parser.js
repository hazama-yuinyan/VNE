var Parse = (function(){
    ...
    var Hash = enchant.Class.create({
    	initialize : function(object){
    		this._object = isHash(object) ? object.toObject() : cloneObject.call(Object, object);
    	},
    	...
    	toObject : function(){
    		return cloneObject.call(Object, this._object);
    	},
            ...
            return {
                ...
                parse: function(tokens){
                    ...
                    if(r){
                        ...
                        var value;
                        if(this.fn){
                            var m = cloneObject.call(Object, r.value);
                            m.name = this.name;
                            value = this.fn(m);
                        }else{
                            value = r.value;
